  ...
  module HTTP
    module Routes
      ...
      module Invite
        ...
        #   object.
        # @vex.api_docs https://discord.com/developers/docs/resources/invite#get-invite
        ...
        #   object.
        # @vex.permissions MANAGE_CHANNELS or MANAGE_GUILD
        # @vex.api_docs https://discord.com/developers/docs/resources/invite#delete-invite
